...
void init_menu(main_t *e)
{
    ...
    e->menu->texture = sfTexture_createFromFile("image/menu_bg.jpg", NULL);
    ...
    e->menu->texture_pp = sfTexture_createFromFile("image/pp.png", NULL);
    ...
    e->menu->pos_pp = (sfVector2f) {700, 700};
